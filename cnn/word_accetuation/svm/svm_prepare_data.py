...
if mode == 'l':
    data.generate_data('../../internal_representations/inputs/letters_word_accentuation_train',
                       ...
                       '../../internal_representations/inputs/letters_word_accentuation_validate', test_set=True)
else:
    data.generate_data('../../internal_representations/inputs/syllables_word_accetuation_train',
                       ...
                       '../../internal_representations/inputs/syllables_word_accetuation_validate', test_set=True)
...
filename = 'data/letters_word_accentuation_x_test_train.pkl'
pickle.dump(final_train, open(filename, 'wb'))
filename = 'data/letters_word_accentuation_x_test_test.pkl'
pickle.dump(final_test, open(filename, 'wb'))
filename = 'data/letters_word_accentuation_y_test_train.pkl'
pickle.dump(data.y_train, open(filename, 'wb'))
filename = 'data/letters_word_accentuation_y_test_test.pkl'
