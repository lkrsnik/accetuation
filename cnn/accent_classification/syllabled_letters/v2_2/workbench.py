...
oversampling = np.ones(13)
oversampling[2] = 5
oversampling[4] = 4
oversampling[5] = 3
oversampling[9] = 8
history = model.fit_generator(data.generator('train', batch_size, content_location='data/', oversampling=oversampling),
...
# name = '20_epoch'
name = 'cnn/accent_classification/syllabled_letters/v2_2/20_test_epoch'
model.save(name + '.h5')
